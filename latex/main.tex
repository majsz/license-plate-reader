...
\begin{frame}{Opis użytych metod}
...
\begin{center}
\texttt{obraz} $\rightarrow$ \texttt{YOLO11n} $\rightarrow$ \texttt{crop tablicy} $\rightarrow$ \texttt{OCR} $\rightarrow$ \texttt{tekst}
\end{center}

\end{frame}

%---------------------------------------------------------
\begin{frame}{Detekcja tablicy -- YOLO11n}
