...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        -- nie zmieniają geometrii.
    \end{enumerate}
    \item Wygenerowano \textbf{12 000} obrazów (\texttt{.jpg} + etykiety YOLO),
    w tym \textbf{$\sim$30\% tablic dwurzędowych}.
    \item Syntetyki trafiają \textbf{tylko do zbioru treningowego} -- val/test pozostają
    w 100\% prawdziwe.
\end{itemize}
